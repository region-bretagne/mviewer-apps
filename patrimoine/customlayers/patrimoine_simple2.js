...
const LAYER_URL = `${GEOSERVER_URL}/${WORKSPACE}/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=interne:patrimoine_simple&outputFormat=application/json&srsName=EPSG:3857`;
const LAYER_ID = "patrimoine_simple";
...
const handle = function (clusters, views) {
  if (clusters.length > 0) {
    ...
    // CrÃ©ation du HTML Ã  partir du template et des features issues de la manipulation des donnÃ©es
    if (l.template) {
