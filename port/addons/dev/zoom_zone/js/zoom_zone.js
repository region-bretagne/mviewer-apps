...
const duration=mviewer.customComponents.zoom_zone.config.duration;
...
// var nbEntities = 0;
// const entitiesParam=mviewer.customComponents.zoom_zone.config.entities;

   // var _prepareReadyEntities = (entitiesParam) => {
    // var label = "";
    // var coord = "";
    // var zoom = "";
    // var nbEntities = 0;
    // entitiesParam.forEach((entity,i) => {
      // label = entity.label;
      // coord = entity.coord;
      // zoom = entity.zoom;
      // nbEntities++;
...
// const bouton="<input class='radioZone' type='radio' id='"+id+"' name='zone' value='"+id+"'><label for='"+id+"'>"+label+"</label>"


// function logArrayElements(id, label) {
    // console.log("<input class='radioZone' type='radio' id='"+id+"' name='zone' value='"+id+"'><label for='"+id+"'>"+label+"</label>");
// };


// entitiesParam.forEach(function(logArrayElements));
