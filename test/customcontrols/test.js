mviewer.customControls.test = (function() {
    /*
     * Private
     */
    var _idlayer = 'test';
    ...
    var _showResult = function (data) {
        ...
        mviewer.customLayers.test.layer.getSource().addFeature(feature);
    };
    ...
    return {
		...
		{mviewer.customControls.test.send_comment(text.value,_xy[0],_xy[1],date_observation.value,mail.value,newFile, nom.value, date_saisie);}
		else
		...
		{
		var xhr = mviewer.customControls.test.getXMLHttpRequest();
		...
		xhr.open("POST", "https://kartenn.region-bretagne.fr/kartoviz/apps/region/test/savecomment.php", true);
		...
		var xhr = mviewer.customControls.test.getXMLHttpRequest();
		xhr.open("POST", "https://kartenn.region-bretagne.fr/kartoviz/apps/region/test/saveimage.php", true);
		xhr.send(formData);
		...
		mviewer.customControls.test.destroy();
        ...
        destroy: function () {
            ...
            mviewer.customLayers.test.layer.getSource().clear();
        },
