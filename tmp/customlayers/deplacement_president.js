const LAYER_URL ="https://ows.region-bretagne.fr/geoserver/interne/wfs?SERVICE=WFS&VERSION=1.0.0&REQUEST=GETFEATURE&TYPENAME=deplacement_president_stock&outputFormat=application/json&srsName=EPSG:4326";
const LAYER_ID = "deplacement_president";
...
const legend = {
    items: [
        {styles: uniqueStyle, label: "Déplacement", geometry: "Point"},
        {styles: manyStyle(10,10,7), label: "Groupe de déplacement", geometry: "Point"}
    ]
};
